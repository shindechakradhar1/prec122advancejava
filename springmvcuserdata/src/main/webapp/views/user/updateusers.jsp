			...
			<div class="row gy-3 mt-5">
				...
				<div class="col-6">
					<div class="form-check form-check-inline">
						<form:input class="form-check-input" type="radio" path="gender" id="inlineRadio1" value="male" />
						<label class="form-check-label" for="inlineRadio1">Male</label>
					</div>
					<div class="form-check form-check-inline">
						<form:input class="form-check-input" type="radio" path="gender" id="inlineRadio2" value="female" />
						<label class="form-check-label" for="inlineRadio2">Female</label>
					</div>
					<div class="form-check form-check-inline">
						<form:input class="form-check-input" type="radio" path="gender" id="inlineRadio2" value="Others" />
